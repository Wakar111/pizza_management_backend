...
app.post('/api/send-order-emails', async (req, res) => {
  try {
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        : '<p style="margin: 5px 0; color: #10b981; font-weight: bold;">✅ Kostenlose Lieferung!</p>'
          ...
          <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb; text-align: center; color: #6b7280; font-size: 14px;">
            <p>Mit freundlichen Grüßen<br><strong>Restaurant Hot Pizza Team</strong></p>
          </div>
        </div>
      </div>
    `
    ...
    const fromEmail = 'Restaurant Hot Pizza <onboarding@resend.dev>'
    ...
    if (ownerResult.error) {
      console.error('❌ Error sending owner email:', ownerResult.error)
    }
